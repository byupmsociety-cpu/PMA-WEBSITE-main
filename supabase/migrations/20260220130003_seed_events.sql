-- Seed events from Airtable CSV export
-- This migration inserts event data into the events table
-- Note: Dates are parsed from format "M/D/YYYY H:MMam/pm" to ISO timestamptz
-- Status "past" maps to is_public=true, "upcoming" maps to is_public=true
